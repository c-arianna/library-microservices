...
public sealed interface UserEvent extends DomainEvent permits UserSubscribedEvent, UserUnsubscribeEvent, 
UserSuspendEvent,UserUnsuspendedEvent, LibraryCardAssignedEvent {
	UserEventType type();
