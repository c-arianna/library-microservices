...
public class UserEventEntity extends BaseEventEntity {
	...
	public UserEventEntity(String aggregateId, String aggregateType, String eventType, String eventId, int eventVersion, Integer schemaVersion, JsonNode payload, Instant  occurredAt) {
