package mentoring.acomi.userservice.architecture;
...
@AnalyzeClasses(packages = "mentoring.acomi.userservice", importOptions = ImportOption.DoNotIncludeTests.class)
