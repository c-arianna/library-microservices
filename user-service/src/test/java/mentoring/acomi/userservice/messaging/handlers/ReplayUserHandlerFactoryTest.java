...
public class ReplayUserHandlerFactoryTest {

    @Mock
    private UserProjectionOperations replayProjection;
    ...
    @BeforeEach
    void setUp() {
        factory = new ReplayUserHandlerFactory(replayProjection, mapper);
    }

    @Test
    void shouldCreateAllReplayableHandlers() {

        Set<Class<?>> expectedHandlers = findReplayableHandlers("mentoring.acomi.userservice.infrastructure.messaging.handlers");
