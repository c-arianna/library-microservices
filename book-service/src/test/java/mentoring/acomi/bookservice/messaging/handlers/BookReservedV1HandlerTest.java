...
public class BookReservedV1HandlerTest extends AbstractBookNotificationHandlerTest {
	...
	@BeforeEach
	void setUp() {
		handler = new BookReservedV1Handler(projection, mapper, notificationService);
	}
