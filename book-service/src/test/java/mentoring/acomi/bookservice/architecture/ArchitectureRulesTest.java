package mentoring.acomi.bookservice.architecture;
...
@AnalyzeClasses(packages = "mentoring.acomi.bookservice", importOptions = ImportOption.DoNotIncludeTests.class)
