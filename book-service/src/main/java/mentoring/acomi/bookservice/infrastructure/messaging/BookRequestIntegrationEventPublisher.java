...
@Component
public class BookRequestIntegrationEventPublisher {
	
	private final RabbitTemplate rabbitTemplate;
	private final BookRequestIntegrationEventMapper mapper;
	private final Tracer tracer;
	
	private static final Logger logger = LogManager.getLogger(BookRequestIntegrationEventPublisher.class);

	public BookRequestIntegrationEventPublisher(RabbitTemplate rabbitTemplate, BookRequestIntegrationEventMapper mapper, Tracer tracer) {
